...
class SettingsCand extends Component{
  ...
  deleteAccount(){
      Meteor.call('deleteAccountCandidate',Meteor.userId(),(err)=>{
        if(!err){
        Meteor.logout( (err) => {
            if (err) {
  ...
  return(
    ...
    <div className="db-right-padded db-width-trim">
        ...
        <div className="settings-item-hold">
            ...
            <p className='csett-text'>This will delete all your data from our servers including your job applications and chats. This operation is not reversible</p>
        ...
        <Rodal width={600} height={270} visible={this.state.confModal}  onClose={this.closeConfModal.bind(this)}  showCloseButton={false}>
            ...
            <div className="edit-model-header mWidth600">
                ...
                <div className="model-dialog-content-holder">
                    <p className="model-dialog-text">Deleting your Stackraft Account will remove all your data from our servers and also terminate all the existing job applications. <span className="bold-text">THIS ACTION IS NOT REVERSIBLE</span></p>
...
export default createContainer((props)=>{
  ...
  return{ theCandidate : candidateDB.find({userID:Meteor.userId()}).fetch()[0]};
}, SettingsCand);
