...
<ChartCard> 
<h2>Prediction</h2>
<h3><b>This patient has  Brain Cancer</b></h3>
<br/>
 

          <h3><b>Confidence</b></h3>
          <h1><b>{87}</b></h1>
           <MiniProgress percent={87} strokeWidth={12} target={80} />
           <br/>
        </ChartCard>
...
<ChartCard className="chart_card_split_l">
  ...
  <br/>
  <img src='/img/sample_img.png' className="uploaded_img"/>
<br/>
<br/>
</ChartCard>
...
<h3>This patient {this.props.patient.initialInfo.age}</h3>
