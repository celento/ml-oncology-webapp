...
var Collapse = /*#__PURE__*/function (_React$Component) {
  ...
  function Collapse() {
    ...
    _this.renderCollapse = function (_ref) {
      ...
      var collapseClassName = (0, _classnames["default"])((_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-borderless"), !bordered), _defineProperty(_classNames, "".concat(prefixCls, "-icon-position-").concat(expandIconPosition), true), _defineProperty(_classNames, "".concat(prefixCls, "-rtl"), direction === 'rtl'), _classNames), className);
