...
function generatePicker(generateConfig) {
  ...
  var RangePicker = /*#__PURE__*/function (_React$Component2) {
    ...
    var _super2 = _createSuper(RangePicker);
      ...
      _this2.renderPicker = function (locale) {
        ...
        return /*#__PURE__*/React.createElement(_SizeContext["default"].Consumer, null, function (size) {
          ...
          return /*#__PURE__*/React.createElement(_rcPicker.RangePicker, _extends({
            ...
            className: (0, _classnames["default"])(className, (_classNames2 = {}, _defineProperty(_classNames2, "".concat(prefixCls, "-").concat(mergedSize), mergedSize), _defineProperty(_classNames2, "".concat(prefixCls, "-borderless"), !bordered), _classNames2))
