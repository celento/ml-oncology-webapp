...
var Annotation = /** @class */ (function (_super) {
        ...
        if (components.length) {
            util_1.each(components, function (co) {
                ...
                if (component.get('type') === 'regionFilter') {
                    ...
                    _this.view.once(constant_1.VIEW_LIFE_CIRCLE.AFTER_RENDER, function () {
    ...
    Annotation.prototype.getAnnotationCfg = function (type, option, theme) {
        ...
        if (type === 'arc') {
            ...
            var startAngle = coordinate_1.getPointAngle(coordinate, sp);
            var endAngle = coordinate_1.getPointAngle(coordinate, ep);
            ...
            o = tslib_1.__assign(tslib_1.__assign({}, this.parsePosition(position)), { content: option.content, rotate: rotate });
        }
        ...
        cfg.animateOption = util_1.deepMix({}, animate_1.DEFAULT_ANIMATE_CFG, cfg.animateOption);
        return cfg;
    };
    /**
