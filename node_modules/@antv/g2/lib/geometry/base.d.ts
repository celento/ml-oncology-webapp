...
export default class Geometry extends Base {
     ...
     * @returns
     */
    getElementId(data: MappingDatum | MappingDatum[]): string;
    /**
     ...
     * @returns elements
     */
    protected createElements(mappingData: MappingDatum[], isUpdate?: boolean): Element[];
    /**
     * 获取虚拟 Group。
     * @returns
     */
    protected getOffscreenGroup(): IGroup;
    /**
     * 获取渲染的 label 类型。
     */
