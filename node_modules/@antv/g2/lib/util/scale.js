...
function getDefaultType(field, data) {
    var type = 'linear';
    var value = util_1.firstValue(data, field);
...
function createScaleByField(field, data, scaleDef) {
    ...
    // 如果已经定义过这个度量
    var type = util_1.get(scaleDef, 'type', getDefaultType(field, validData));
    var cfg = {
        field: field,
        values: util_1.valuesOfKey(validData, field),
    };
    util_1.mix(cfg, scaleDef);
