...
<html lang="en">
<head>
    <title>Code coverage report for dom.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> dom.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">35x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { forEach } from './utils';
&nbsp;
...
&nbsp;
  ...
  for (var prop in attr) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (entry.hasOwnProperty(prop)) {
