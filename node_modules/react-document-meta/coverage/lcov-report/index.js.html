...
function handleStateChangeOnClient(props) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (canUseDOM) {
...
&nbsp;
function ograph(p) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!p.meta) {
<span class="cstat-no" title="statement not covered" >    p.meta = {};</span>
  }
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!p.meta.property) {
    p.meta.property = {};
  }
&nbsp;
  const group = p.meta.property;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (group) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (p.title &amp;&amp; !group['og:title']) {
      group['og:title'] = p.title;
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (p.hasOwnProperty('description') &amp;&amp; !group['og:description']) {
      group['og:description'] = p.description;
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (p.hasOwnProperty('canonical') &amp;&amp; !group['og:url']) {
...
function getTags(_props) {
  return [].concat(
    _props.base ? [{ tagName: 'base', href: _props.base }] : [],
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (tagName === 'meta' || tagName === 'link' || tagName === 'base') {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Wed Mar 21 2018 15:04:48 GMT+0100 (CET)
</div>
</div>
